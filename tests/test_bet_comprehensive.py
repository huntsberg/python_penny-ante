...
class TestBetComprehensive(unittest.TestCase):
    ...
    def test_street_bet_validation_errors(self):
        ...
        self.assertIn(
            "Street bet must cover exactly three spaces", str(context.exception)
        )
    ...
    def test_corner_bet_validation_errors(self):
        ...
        self.assertIn(
            "Corner bet must cover exactly four spaces", str(context.exception)
        )
    ...
    def test_six_line_bet_validation_errors(self):
        ...
        self.assertIn(
            "Six line bet must cover exactly six spaces", str(context.exception)
        )
    ...
    def test_bet_with_zero_and_double_zero(self):
        ...
        bet_00 = Bet.create_straight_up_bet(
            "00", amount=10, layout=self.american_layout
        )
        ...
        bet_0_euro = Bet.create_straight_up_bet(
            "0", amount=10, layout=self.european_layout
        )
    ...
    def test_non_digit_spaces_for_outside_bets(self):
        ...
        black_bet = Bet.create_color_bet(
            "black", amount=20, layout=self.american_layout
        )
    ...
    def test_layout_positions_for_multiple_spaces(self):
        ...
        split_bet = Bet.create_split_bet(
            "17", "18", amount=10, layout=self.american_layout
        )
    ...
    def test_bet_with_chips_parameter(self):
        ...
        bet = Bet.create_straight_up_bet(
            "17", amount=5, chips=chips, layout=self.american_layout
        )
    ...
    def test_payout_calculations_for_all_bet_types(self):
        ...
        straight_bet = Bet.create_straight_up_bet(
            "17", amount=10, layout=self.american_layout
        )
        ...
        street_bet = Bet(
            BetType.STREET, ["17", "18", "19"], amount=10, layout=self.american_layout
        )
    ...
    def test_european_vs_american_table_differences(self):
        ...
        european_bet_00 = Bet(
            BetType.STRAIGHT_UP, "00", amount=10, layout=self.european_layout
        )
    ...
    def test_large_bet_amounts(self):
        ...
        large_bet = Bet.create_straight_up_bet(
            "17", amount=1000000, layout=self.american_layout
        )
        winning_space = Space("17")
    ...
    def test_bet_creation_edge_cases(self):
        ...
        max_bet = Bet.create_straight_up_bet(
            "36", amount=1, layout=self.american_layout
        )
    ...
    def test_case_insensitive_color_bets(self):
        ...
        red_bet_upper = Bet.create_color_bet(
            "RED", amount=20, layout=self.american_layout
        )
        red_bet_mixed = Bet.create_color_bet(
            "Red", amount=20, layout=self.american_layout
        )
        ...
        black_bet_upper = Bet.create_color_bet(
            "BLACK", amount=20, layout=self.american_layout
        )
        black_bet_mixed = Bet.create_color_bet(
            "Black", amount=20, layout=self.american_layout
        )
