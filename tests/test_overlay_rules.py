...
class TestOverlayRules(unittest.TestCase):
    ...
    def test_table_limits_overlay(self):
        ...
        overlay = {"table_limits": {"minimum_bet": 25, "maximum_bet": 5000000}}
    ...
    def test_payout_ratios_overlay(self):
        ...
        overlay = {"payout_ratios": {"straight_up": 40, "split": 20}}
    ...
    def test_game_rules_overlay(self):
        ...
        overlay = {"game_rules": {"surrender": True, "maximum_repeats": 5}}
    ...
    def test_comprehensive_overlay(self):
        ...
        overlay = {
            "table_limits": {"minimum_bet": 100},
            "payout_ratios": {"straight_up": 42},
            "game_rules": {"surrender": True},
            "minimum_bet_ratios": {"red": 10.0},
        }
    ...
    def test_european_base_with_overlay(self):
        ...
        overlay = {
            "table_limits": {"minimum_bet": 5},
            "game_rules": {"la_partage": False},
        }
    ...
    def test_game_class_integration(self):
        ...
        overlay = {
            "table_limits": {"minimum_bet": 50},
            "payout_ratios": {"straight_up": 38},
        }
    ...
    def test_overlay_validation_still_works(self):
        ...
        overlay = {"table_limits": {"minimum_bet": 50}}
...
"""
        ...
        try:
            overlay = {
                "table_limits": {"minimum_bet": 20},
                "payout_ratios": {"straight_up": 45},
            }
