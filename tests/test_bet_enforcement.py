...
"""
    ...
    def test_individual_bet_amount_limits(self):
        ...
        with self.assertRaises(ValueError) as context:
            bet = Bet.create_straight_up_bet("17", amount=5, 
        ...
        with self.assertRaises(ValueError) as context:
            bet = Bet.create_straight_up_bet("17", amount=500,  # Max is 100 (1000 * 0.1)
                                           layout=strict_game.table.layout,
                                           betting_rules=strict_game.betting_rules)
        self.assertIn("outside allowed range", str(context.exception))
        
        # Test valid bet
        bet = Bet.create_straight_up_bet("17", amount=50,
                                       layout=strict_game.table.layout,
                                       betting_rules=strict_game.betting_rules)
    ...
    def test_total_bet_limit_enforcement(self):
        ...
        bet1 = Bet.create_color_bet("red", amount=500, layout=strict_game.table.layout,
                                   betting_rules=strict_game.betting_rules)
        bet2 = Bet.create_color_bet("black", amount=500, layout=strict_game.table.layout,
                                   betting_rules=strict_game.betting_rules)
        bet3 = Bet.create_straight_up_bet("17", amount=50, layout=strict_game.table.layout,
                                        betting_rules=strict_game.betting_rules)
        ...
        bet4 = Bet.create_dozen_bet(1, amount=1000, layout=strict_game.table.layout,
                                  betting_rules=strict_game.betting_rules)
        strict_game.place_bet(bet4, "Charlie")  # This should work (total = 2000)
        
        # Now try to add one more bet that would exceed the limit
        bet5 = Bet.create_straight_up_bet("23", amount=50, layout=strict_game.table.layout,
                                        betting_rules=strict_game.betting_rules)
    ...
    def test_player_chip_balance_enforcement(self):
        ...
        large_bet = Bet.create_color_bet("red", amount=1500, layout=self.game.table.layout,
        ...
        valid_bet = Bet.create_color_bet("red", amount=100, layout=self.game.table.layout,
                                       betting_rules=self.game.betting_rules)
    ...
    def test_betting_phase_management(self):
        ...
        # Place a bet
        bet = Bet.create_color_bet("red", amount=50, layout=self.game.table.layout,
                                 betting_rules=self.game.betting_rules)
        ...
        another_bet = Bet.create_color_bet("black", amount=50, layout=self.game.table.layout,
                                         betting_rules=self.game.betting_rules)
        with self.assertRaises(ValueError) as context:
    ...
    def test_multiple_bet_validation(self):
        ...
        bets = [
            Bet.create_straight_up_bet("17", amount=100, layout=self.game.table.layout,
                                     betting_rules=self.game.betting_rules),
            Bet.create_color_bet("red", amount=200, layout=self.game.table.layout,
                               betting_rules=self.game.betting_rules),
            Bet.create_dozen_bet(1, amount=150, layout=self.game.table.layout,
                                betting_rules=self.game.betting_rules)
        ]
...
"""
        ...
        allowed_bet = Bet.create_straight_up_bet("17", amount=50,
        ...
        with self.assertRaises(ValueError) as context:
            disallowed_bet = Bet.create_color_bet("black", amount=50,
                                                 layout=limited_game.table.layout,
                                                 betting_rules=limited_game.betting_rules)
    ...
    def test_special_rules_enforcement(self):
        ...
        self.assertFalse(self.game.betting_rules.is_special_rule_enabled('allow_call_bets'))
        self.assertTrue(self.game.betting_rules.is_special_rule_enabled('progressive_betting'))
    ...
    def test_bet_summary_and_tracking(self):
        ...
        # Place several bets
        bet1 = Bet.create_straight_up_bet("17", amount=100, layout=self.game.table.layout,
                                        betting_rules=self.game.betting_rules)
        bet2 = Bet.create_color_bet("red", amount=200, layout=self.game.table.layout,
                                  betting_rules=self.game.betting_rules)
        bet3 = Bet.create_straight_up_bet("23", amount=150, layout=self.game.table.layout,
                                        betting_rules=self.game.betting_rules)
