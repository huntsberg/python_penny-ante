...
class Bet:
    ...
    def is_winning_bet(self, winning_space: "Space") -> bool:
        ...
        if self.bet_type == BetType.RED:
            ...
            return winning_value.isdigit() and int(winning_value) > 0 and int(winning_value) % 2 == 1
        elif self.bet_type == BetType.EVEN:
            return winning_value.isdigit() and int(winning_value) > 0 and int(winning_value) % 2 == 0
            ...
            return winning_value.isdigit() and int(winning_value) in [1,4,7,10,13,16,19,22,25,28,31,34]
        elif self.bet_type == BetType.SECOND_COLUMN:
            return winning_value.isdigit() and int(winning_value) in [2,5,8,11,14,17,20,23,26,29,32,35]
        elif self.bet_type == BetType.THIRD_COLUMN:
            return winning_value.isdigit() and int(winning_value) in [3,6,9,12,15,18,21,24,27,30,33,36]
    ...
    def create_color_bet(
        ...
        if color_lower == "red":
            ...
            spaces = ["1","3","5","7","9","12","14","16","18","19","21","23","25","27","30","32","34","36"]
        elif color_lower == "black":
            bet_type = BetType.BLACK
            # Black numbers in roulette
            spaces = ["2","4","6","8","10","11","13","15","17","20","22","24","26","28","29","31","33","35"]
        else:
    ...
    def create_column_bet(
        ...
        if column == 1:
            ...
            spaces = ["1","4","7","10","13","16","19","22","25","28","31","34"]
        elif column == 2:
            bet_type = BetType.SECOND_COLUMN
            spaces = ["2","5","8","11","14","17","20","23","26","29","32","35"]
        elif column == 3:
            bet_type = BetType.THIRD_COLUMN
            spaces = ["3","6","9","12","15","18","21","24","27","30","33","36"]
        else:
